...
export default function GetAQuote() {
  return (
    <section className="bg-[url('/images/pic1.webp')] bg-cover bg-center p-[5%] relative pb-[250px] md:pb-[200px] md:pt-[100px] lg:pt-[190px] lg:pb-[250px]">
      ...
      <div className={`${productSansRegular.className } absolute bottom-0 left-0 bg-sky-800 w-full text-white p-5 lg:px-[5%] lg:flex lg:justify-between lg:items-center`}>
          <p>16 Ely Close Greencroft, Harare, Zimbabwe - <Viewmap /></p>
